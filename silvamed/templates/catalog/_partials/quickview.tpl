    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="quickview-product-card" class="row">
          ...
          <div class="col-12 col-md-5 col-lg-6 pt-3 quickview-information">
            <h1 class="h2 product-name mb-2 d-none d-lg-block">{$product.name}</h1>
            <h1 class="h4 product-name mb-2 d-lg-none">{$product.name}</h1>
            {block name='product_description_short'}
              <div id="product-description-short-{$product.id}" class="product-description-short d-none d-xl-block" itemprop="description">{$product.description_short nofilter}</div>
            {/block}
