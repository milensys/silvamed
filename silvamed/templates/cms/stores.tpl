...
{block name='page_header_container'}
  {block name='page_title'}
    <header class="page-header row">
      <h1 class="mb-lg-6 col-12 offset-lg-2 col-lg-8 px-0">{l s='Our stores' d='Shop.Theme.Global'}</h1>
    </header>
  {/block}
{/block}
...
{block name='page_content_container'}
  <section id="content" class="page-content page-stores row">
    ...
    {foreach $stores as $store}
      <article id="store-{$store.id}" class="store-item card col-12 offset-lg-2 col-lg-8">
