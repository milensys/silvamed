 ...
 *}
<section id="order-summary-content" class="page-content page-order-confirmation pt-5">
  <div class="row">
    <div class="col-md-12">
      <h4 class="h2 black">{l s='Please check your order before payment' d='Shop.Theme.Checkout'}</h4>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {l s='Addresses' d='Shop.Theme.Checkout'}
        <small class="link link-dark" onclick="document.getElementById('checkout-addresses-step-tab').click()">
    ...
    <div class="col-md-6">
      <div class="noshadow">
        <div class="p-3 bg-light">
          ...
          <small>{$customer.addresses[$cart.id_address_delivery]['formatted'] nofilter}</small>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="noshadow">
        <div class="p-3 bg-light">
          ...
          <small>{$customer.addresses[$cart.id_address_invoice]['formatted'] nofilter}</small>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row mb-6">
    <div class="col-md-12">
      ...
      {l s='Shipping Method' d='Shop.Theme.Checkout'}
        <small class="link link-dark" onclick="document.getElementById('checkout-delivery-step-tab').click()">
          <i class="linearicons-pencil" aria-hidden="true"></i>
          {l s='edit' d='Shop.Theme.Actions'}
        </small>
      </h4>
