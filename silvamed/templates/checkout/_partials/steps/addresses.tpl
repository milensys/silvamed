  ...
  <div class="js-address-form">
    ...
    >
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <div class="row mb-5">
          <p class="add-address col-auto">
            <a class="btn-social-icon" href="{$new_address_delivery_url}"><i class="fa fa-plus-square btn-warning" aria-hidden="true"></i>{l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>

          {if $use_same_address && !$cart.is_virtual}
            <p class="col">
              <a class="btn-social-icon" data-link-action="different-invoice-address" href="{$use_different_address_url}">
                <i class="fa fa-university btn-info" aria-hidden="true"></i>{l s='Billing address differs from shipping address' d='Shop.Theme.Checkout'}
              </a>
            </p>
          {/if}
        </div>
      ...
      {if !$use_same_address}
        <div class="invoice-address-wrapper">
          ...
          {else}
            ...
            <p class="add-address">
              <a href="{$new_address_invoice_url}"><i class="fa fa-plus-square mr-1" aria-hidden="true"></i>{l s='add new address' d='Shop.Theme.Actions'}</a>
            </p>
          {/if}
        </div>
      {/if}
