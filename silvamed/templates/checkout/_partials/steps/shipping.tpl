    ...
    {if $delivery_options|count}
      ...
      >
        <div class="form-fields">
          {block name='delivery_options'}
            <div class="delivery-options">
              {foreach from=$delivery_options item=carrier key=carrier_id}
                <div class="delivery-option-item mb-2{if $delivery_option == $carrier_id} current{/if}">
                        ...
                        <div class="row">
                          <div class="col-sm-5">
                            <div class="row">
                              ...
                              {/if}
                              <div class="{if $carrier.logo}col-8{else}col-12{/if}">
          ...
          {/block}
          <div class="order-options mb-3">
            <div id="delivery">
              <label class="h6" for="delivery_message">{l s='If you would like to add a comment about your order, please write it in the field below.' d='Shop.Theme.Checkout'}</label>
        ...
        <button type="submit" class="continue btn btn-primary btn-md" name="confirmDeliveryOption" value="1">
