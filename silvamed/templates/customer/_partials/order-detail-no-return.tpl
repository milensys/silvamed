...
{block name='order_products_table'}
  ...
  <div class="order-items hidden-md-up border p-3 mb-3">
    {foreach from=$order.products item=product}
      <div class="order-item">
        <div class="row">
          <div class="col-sm-5 col-12 desc">
  ...
  <div class="order-totals hidden-md-up border p-3 mb-3">
    {foreach $order.subtotals as $line}
      {if $line.value}
