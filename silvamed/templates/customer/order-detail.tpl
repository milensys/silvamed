...
{block name='page_content'}
  {block name='order_infos'}
    <div id="order-infos">
      <div class="border p-3 mb-3">
        <div class="row">
          <div class="col-{if $order.details.reorder_url}9{else}12{/if} align-items-center">
            <p><strong>
              {l
          ...
          {if $order.details.reorder_url}
            <div class="col-3 text-sm-right">
              <a href="{$order.details.reorder_url}" class="button-primary btn btn-primary btn-sm">{l s='Reorder' d='Shop.Theme.Actions'}</a>
            </div>
          {/if}
  ...
  {block name='order_history'}
    <section id="order-history" class="border p-3 mb-3">
    ...
    <div class="addresses row">
      {if $order.addresses.delivery}
        <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
          <article id="delivery-address" class="border p-2">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
        <article id="invoice-address" class="border p-2">
