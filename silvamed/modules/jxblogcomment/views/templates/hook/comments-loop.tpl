...
<section id="blog-comments" data-post-id="{$post.id_jxblog_post}" class="my-6">
  <h3 class="h3 products-section-title text-center">{l s='Post comments' mod='jxblogcomment'}</h3>
  {if $isLogged}
